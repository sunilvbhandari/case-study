...
import { TransactionInfo, Transaction } from '../models/transaction';
import { VehicleType, Vehicle, Car, Truck } from '../models/vehicle';
...
export class DashboardComponent implements OnInit {
  ...
  getVehicle(transactionInfo: TransactionInfo): Vehicle {
    ...
    let vehicle: Vehicle;
    const vehicleTypes: VehicleType = VehicleType[transactionInfo.vehicleType];
